-- ✅ STEP 1: Create your tables (SQL)
-- In Supabase, click SQL Editor → New query and paste this:
...
-- Couple members - partner membership
...
-- MUST be enabled before any policies will take effect.
-- FORCE ensures RLS applies even to table owners / superusers,
-- preventing accidental bypass.
