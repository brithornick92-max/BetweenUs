          ...
          <Animated.View entering={FadeInDown.delay(200).duration(800)} style={styles.documentBody}>
            ...
            <View style={[styles.section, { borderTopColor: theme.glassBorder }]}>
              ...
              <Text style={[styles.paragraph, { color: colors.textMuted || 'gray' }]}>
                ...
                • Premium starts with 100 prompts, 100 date ideas, and 10 sex positions, adds 15 prompts, 15 date ideas, and 3 sex positions each week from the day premium starts, and includes the Vibe Signal screen plus the full Keepsake archive beyond the free 30-day window{'\n'}
