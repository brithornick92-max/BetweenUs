...
BEGIN
  ...
  CASE NEW.data_type
    ...
    WHEN 'custom_ritual' THEN notif_title := '🌙 New Ritual';
                              ...
                              notif_data := notif_data || jsonb_build_object('route', 'ritual');
