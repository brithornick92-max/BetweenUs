...
export const TODAY_BETWEEN_US_ROTATION_CYCLE_DAYS = 365;
export const TODAY_BETWEEN_US_GLOBAL_SCOPE = 'global:today-between-us';
...
export function selectTodayBetweenUsPrompt(promptPool, dateKey) {
