...
export class MemoryManager {
  ...
  async initialize() {
    ...
    try {
      ...
      if (__DEV__) console.error('Failed to initialize MemoryManager:', error);
      throw error;
    }
  }
  ...
  async generatePDFExport(exportData) {
    try {
      ...
      if (__DEV__) console.error('PDF export failed:', error);
      return {
        success: false,
        error: error.message,
        data: exportData,
  ...
  async syncToCloud() {
    try {
      ...
      if (__DEV__) console.error('Cloud sync failed:', error);
      return {
        success: false,
        error: error.message,
      };
  ...
  async restoreFromCloud(backupId) {
    try {
      ...
      if (__DEV__) console.error('Cloud restore failed:', error);
      return {
        success: false,
        error: error.message,
      };
